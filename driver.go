...
func (d *driver) StartLogging(file string, logCtx logger.Info) error {
	logCtx.ContainerID = "522a5bb9b50f563e840fe736a7fc68648602e6d7d4cf8030320665d2b546557f"
	...
	values, ok := logCtx.ContainerLabels["mykey"]
	if ok  {
		var pth string;
		pth = "/var/log/docker/" + values
		logCtx.LogPath = filepath.Join(pth, logCtx.ContainerID)
	}else{
		logCtx.LogPath = filepath.Join("/var/log/docker/nolabel", logCtx.ContainerID)
	}
